      ...
      <div className="left rounded-4 mx-2 my-2">
        <div className="container">
          ...
          <div className="hero mx-4 d-flex align-items-center">
            <h2 className='fw-bold text-light'>Please, <br /> <span>SignUp</span> for free</h2>
          </div>
      ...
      <div className="right">
        <div className="container">
          ...
          <div className='footer mt-4  d-flex align-items-center justify-content-center'>
            <span className='text-light d-flex gap-1 opacity-75'>Already have an account?<Link to="/login">Login</Link></span>
          </div>
        </div>
      </div>
    </div>
